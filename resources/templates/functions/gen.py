...
temp_head = get_contents(
    ARCTK_DIR + "/resources/templates/functions/header.hpp.in")
temp_impl = get_contents(
    ARCTK_DIR + "/resources/templates/functions/implementation.inl.in")
temp_test = get_contents(
    ARCTK_DIR + "/resources/templates/functions/test.cpp.in")
