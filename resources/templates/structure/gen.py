...
temp_head = get_contents(
    ARCTK_DIR + "/resources/templates/structure/header.hpp.in")
temp_impl = get_contents(
    ARCTK_DIR + "/resources/templates/structure/implementation.inl.in")
temp_test = get_contents(
    ARCTK_DIR + "/resources/templates/structure/test.cpp.in")


#   -- Replacements --
temp_head = temp_head.replace("@NAMESPACES_OPEN@", get_namespaces_open())
temp_head = temp_head.replace("@STRUCTURE_NAME@", get_class_name())
