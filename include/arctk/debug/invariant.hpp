...
namespace arc //! arctk namespace
{
    namespace debug //! debugging namespace
    {
        ...
        class Invariant
        {
          ...
          public:
            //  -- Constructors --
            inline Invariant(const std::string& file_, const long int line_, const std::string& func_, const std::string& expr_str_, const std::function<T()>& expr_);
         ...
         */
        template <typename T>
        inline Invariant<T>::Invariant(const std::string& file_, const long int line_, const std::string& func_, const std::string& expr_str_, const std::function<T()>& expr_)
          : _file(file_)
          , _line(line_)
          , _func(func_)
          , _expr_str(expr_str_)
