...
namespace arc //! arctk namespace
{
    namespace debug //! debugging namespace
    {
        namespace contract //! contracts namespace
        {
            ...
            //  == FUNCTION PROTOTYPES ==
            //  -- Contracts --
            inline bool precondition(const std::string& condition_, const std::string& file_, int line_, const std::string& func_) noexcept;
            inline bool postcondition(const std::string& condition_, const std::string& file_, int line_, const std::string& func_) noexcept;
