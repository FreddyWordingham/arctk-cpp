...
#ifdef VERBOSE
#define VERB arc::log::output::Message(__FILE__, __func__, __LINE__) << "" //!< Log a standard message to console output.
#else
...
#define PROGRESS(ms_) arc::log::output::Progress((ms_)) << ""                                         //!< Log a progress update.
