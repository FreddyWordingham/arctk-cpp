...
namespace arc //! arctk namespace
{
    namespace geom //! geometry namespace
    {
        namespace shape //! shape namespace
        {
            ...
            {
                const double length_ab = (_pos[index::vertex::ALPHA] - _pos[index::vertex::BETA]).mag;
                const double length_bc = (_pos[index::vertex::BETA] - _pos[index::vertex::GAMMA]).mag;
                const double length_ca = (_pos[index::vertex::GAMMA] - _pos[index::vertex::ALPHA]).mag;
