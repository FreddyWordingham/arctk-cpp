        ...
        namespace output //! console output namespace
        {
            ...
            class Stopwatch : public Output
            {
              ...
              public:
                ...
                inline Stopwatch(const Stopwatch&) noexcept = delete; //!< Deleted copy constructor.
                inline Stopwatch(Stopwatch&&) noexcept      = delete; //!< Deleted move constructor.
              ...
              public:
                //  -- Assignment --
                inline Stopwatch& operator=(const Stopwatch&) noexcept = delete; //!< Deleted copy operator. @return Reference to copied object.
                inline Stopwatch& operator=(Stopwatch&&) noexcept = delete;      //!< Deleted move operator. @return Reference to moved object.
...
#pragma clang diagnostic pop
            ...
            {
                *this << _col << " took: " << str::time(static_cast<uint64_t>(std::chrono::duration_cast<std::chrono::microseconds>(std::chrono::high_resolution_clock::now() - _construct_time).count()));
