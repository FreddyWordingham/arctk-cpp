...
//  == GUARD ==
#ifndef ARCTK_GUI_SHADER_INL
#define ARCTK_GUI_SHADER_INL
    ...
    namespace gui //! graphical-user-interface namespace
    {
        ...
        inline GLuint Shader::init_handle(const std::string& vert_code_, const std::string& frag_code_) const noexcept
        {
            ...
            if (success == GL_FALSE)
            {
                ...
                std::string error_text(std::begin(error_log), std::end(error_log));
