...
namespace arc //! arctk namespace
{
    namespace rng //! utility namespace
    {
        namespace distribution //! distribution namespace
        {
            ...
            template <typename T>
            inline T normal(
              Generator& rng_) noexcept; // NOLINT //!< Generate a random number drawn from the normal distribution. @tparam T Type to draw from normal distribution. @param  rng_    Generator used to draw base values from. @return Value randomly drawn
                                         //!< from normal distribution.
            template <typename T>
            inline T guassian(
              Generator& rng_, const T mu_,
              const T sigma_) noexcept; // NOLINT //!< Generate a random number drawn from a gaussian distribution.  @tparam T Type to draw from guassian distribution. @param  rng_    Generator used to draw base values from. @param  mu_     Average
