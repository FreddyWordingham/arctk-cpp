    ...
    namespace torus //! transport of radiation under skin namespace
    {
        ...
        class Sim
        {
          ...
          public:
            ...
            inline type::collision collide(double inter_, const std::optional<std::pair<equip::Entity*, geom::Collision>>& ent_, const std::optional<double>& leaf_, const std::optional<double>& block_, const std::optional<double>& dom_) const noexcept;
