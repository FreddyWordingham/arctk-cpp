...
namespace arc //! arctk namespace
{
    namespace data //! data namespace
    {
        ...
        inline std::pair<Packet*, geom::shape::Aabb> Domain::packet(const vec3& pos_) noexcept
        {
            ...
            const vec3 min = -_min + vec3(_packet_size.x * static_cast<double>(index_x), _packet_size.y * static_cast<double>(index_y), _packet_size.z * static_cast<double>(index_z));
