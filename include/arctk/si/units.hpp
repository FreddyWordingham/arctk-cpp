...
namespace arc
{
    ...
    CONVERT_SET_DECL(si::Time, week, x * 604800, x / 604800);
    CONVERT_SET_DECL(si::Time, month, x * 2.628e+6, x / 2.628e+6);
    ...
    CONVERT_SET_DECL(si::Temperature, oF, (x + 459.67) * (1.0 / 1.8), (x * 1.8) - 459.67);
