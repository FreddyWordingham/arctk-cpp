    ...
    namespace equip //! equipment namespace
    {
        namespace entity //! entity namespace
        {
            ...
            class Light : public Entity
            {
              ...
              private:
                //  -- Collision --
                inline bool hit_front(random::Generator* /*unused*/, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept override;
                inline bool hit_back(random::Generator* /*unused*/, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept override;
            };
            ...
            //  -- Collision --
            inline bool Light::hit_front(random::Generator* /*unused*/, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept
            {
            ...
            inline bool Light::hit_back(random::Generator* /*unused*/, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept
            {
                phot_->move(coll_.dist() + consts::num::BUMP, sop_->ref_index());
