    ...
    namespace equip //! equipment namespace
    {
        namespace entity //! entity namespace
        {
            ...
            class Mirror : public Entity
            {
              ...
              private:
                //  -- Collision --
                inline bool hit_front(random::Generator* rng_, phys::Photon* phot_, const opt::Mat** /*unused*/, std::unique_ptr<opt::Sop>* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept override;
                inline bool hit_back(random::Generator* rng_, phys::Photon* phot_, const opt::Mat** /*unused*/, std::unique_ptr<opt::Sop>* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept override;
            };
             ...
             */
            inline bool Mirror::hit_front(random::Generator* rng_, phys::Photon* phot_, const opt::Mat** /*unused*/, std::unique_ptr<opt::Sop>* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept
            {
                assert(rng_ != nullptr);
             ...
             *  @return False if the photon should be removed from the simulation.
             */
            inline bool Mirror::hit_back(random::Generator* rng_, phys::Photon* phot_, const opt::Mat** /*unused*/, std::unique_ptr<opt::Sop>* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept
            {
                assert(rng_ != nullptr);
                assert(phot_ != nullptr);
                assert(sop_ != nullptr);
