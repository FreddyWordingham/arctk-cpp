    ...
    namespace equip //! equipment namespace
    {
        namespace entity //! entity namespace
        {
            ...
            class Mirror : public Entity
            {
              ...
              private:
                //  -- Collision --
                inline bool hit_front(random::Generator* rng_, phys::Photon* phot_, phys::Mat* /*unused*/, std::unique_ptr<arc::phys::Sop>* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept override;
                inline bool hit_back(random::Generator* rng_, phys::Photon* phot_, phys::Mat* /*unused*/, std::unique_ptr<arc::phys::Sop>* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept override;
            };
            ...
            //  == METHODS ==
            //  -- Collision --
            inline bool Mirror::hit_front(random::Generator* rng_, phys::Photon* phot_, phys::Mat* /*unused*/, std::unique_ptr<arc::phys::Sop>* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept
            {
            ...
            inline bool Mirror::hit_back(random::Generator* rng_, phys::Photon* phot_, phys::Mat* /*unused*/, std::unique_ptr<arc::phys::Sop>* sop_, phys::Cell* /*unused*/, const geom::Collision& coll_) noexcept
            {
