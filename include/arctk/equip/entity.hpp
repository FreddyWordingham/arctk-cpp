...
namespace arc //! arctk namespace
{
    namespace equip //! equipment namespace
    {
        ...
        class Entity : public geom::shape::Mesh
        {
          ...
          public:
            //  -- Collision --
            inline bool hit(random::Generator* rng_, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept;

          private:
            //  -- Collision --
            virtual bool hit_front(random::Generator* rng_, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept = 0;
            virtual bool hit_back(random::Generator* rng_, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept  = 0;
        };
        ...
        //  == METHODS ==
        //  -- Collision --
        inline bool Entity::hit(random::Generator* rng_, phys::Photon* phot_, phys::Sop* sop_, phys::Cell* cell_, const geom::Collision& coll_) noexcept
        {
            if (coll_.front())
            {
