...
namespace arc //! arctk namespace
{
    namespace str //! string namespace
    {
        ...
        inline std::string to_string(const C& cont_, size_t width_ = settings::DEFAULT_PRINT_WIDTH, const std::string& pre_ = "{", char delim_ = settings::DEFAULT_DELIM, const std::string& post_ = "}");
        template <typename A0, typename A1>
        inline std::string to_string(const std::pair<A0, A1>& pair_, size_t width_ = settings::DEFAULT_PRINT_WIDTH, const std::string& pre_ = "(", char delim_ = settings::DEFAULT_DELIM, const std::string& post_ = ")");
        template <typename... A>
        inline std::string to_string(const std::tuple<A...>& tup_, size_t width_ = settings::DEFAULT_PRINT_WIDTH, const std::string& pre_ = "(", char delim_ = settings::DEFAULT_DELIM, const std::string& post_ = ")");
