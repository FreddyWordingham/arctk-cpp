...
namespace arc //! arctk namespace
{
    namespace math //! mathematical namespace
    {
        ...
        {
            stream_ << io::format::OPENERS[io::format::container::MAT] << io::format::DELIM << mat_.x << io::format::DELIM << mat_.y << io::format::DELIM << mat_.z << io::format::CLOSERS[io::format::container::MAT];
