    ...
    namespace math //! mathematical namespace
    {
        ...
        class Vec<T, 4>
        {
          ...
          public:
            ...
            //  -- Printing --
            template <typename S>
            friend constexpr inline std::ostream& operator<<(std::ostream& stream_, const Vec<S, 4>& vec_) noexcept;
        ...
        //  -- Printing --
        template <typename T>
        constexpr inline std::ostream& operator<<(std::ostream& stream_, const Vec<T, 4>& vec_) noexcept
        {
